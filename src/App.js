  ...
  render() {
    return (
      ...
      <div className="button">
                ...
                <button className="btn btn-danger button-calculator" name="C" onClick={this.reset}>C</button>
                <button name="0" onClick={this.addequation}>0</button>
                <button className="btn btn-success"name="=" onClick={this.calculate}>=</button>
                <button className="btn btn-primary button-calculator"name="/" onClick={this.addequation}>÷</button><br/>
            </div>
  </div>
    );
